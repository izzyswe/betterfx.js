...
the point is make it a python/powerfx like experience
ease of use like powerfx but extensibility and simplicity like python.

A library of commonly used lines of code compact into functions with callback functions.
